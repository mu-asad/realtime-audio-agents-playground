...
# def create_calendar_tools() -> List[Dict[str, Any]]:
#     """Create tool definitions for calendar operations."""
#     return [
#         {
#             "type": "function",
...
#                     "start_time": {
#                         "type": "string",
#                         "description": "Start time in ISO format (e.g., '2024-01-01T14:00:00Z')"
#                     },
#                     "end_time": {
#                         "type": "string",
#                         "description": "End time in ISO format"
...
#
#
# def create_spotify_tools() -> List[Dict[str, Any]]:
#     """Create tool definitions for Spotify operations."""
#     return [
#         {
#             "type": "function",
#             "name": "spotify_play",
#             "description": "Play music on Spotify. Can play by URI or search for a song/artist/album.",
#             "parameters": {
#                 "type": "object",
#                 "properties": {
#                     "uri": {
...
#                     "search_query": {
#                         "type": "string",
#                         "description": "Search query to find and play music (e.g., 'Bohemian Rhapsody by Queen')"
#                     },
#                     "device_id": {
#                         "type": "string",
#                         "description": "Specific device ID to play on"
#                     }
#                 }
#             }
#         },
...
#     """Route tool calls to the appropriate MCP agent."""
#
#     # Calendar tools
#     if tool_name == "list_calendar_events":
#         if not calendar_agent:
#             return {"error": "Calendar agent not connected"}
#         return await calendar_agent.list_events(
...
#         if not calendar_agent:
#             return {"error": "Calendar agent not connected"}
#         return await calendar_agent.get_event(arguments["event_id"])
#
#     # Spotify tools
#     elif tool_name == "spotify_play":
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.play(
...
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.pause(device_id=arguments.get("device_id"))
#
#     elif tool_name == "spotify_next":
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.next_track(device_id=arguments.get("device_id"))
#
#     elif tool_name == "spotify_previous":
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.previous_track(device_id=arguments.get("device_id"))
#
#     elif tool_name == "spotify_get_devices":
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.get_devices()
#
#     elif tool_name == "spotify_get_current_track":
#         if not spotify_agent:
#             return {"error": "Spotify agent not connected"}
#         return await spotify_agent.get_current_track()
#
#     else:
